...
<header class="primaryHeader">
        ...
        <ul>
            ...
            <li>
                ...
                <ul class="childMenu" style="display: block;">
                    ...
                    <li>
                        <a href="doctersmaster" class="activeMenu">
 ...
 <section class="dataContainer">
        ...
        <div class="addSpeciality">
            <input type="text" name="" id="speciality" class="form-control mr-10 max-300" placeholder="Enter Speciality">
            <button class="btn btn-primary" id="addspeciality">Add</button>
            <span class="ml-auto mr-10">Status</span>
            <select name="" id="" class="form-control max-250">
                <option value="">Select One</option>
            </select>
            <button class="btn btn-primary ml-10">Go</button>
        </div>
